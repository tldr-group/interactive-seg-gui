...
# up_chk_path = "vulture/trained_models/lu_reg_ac48.pth"
# denoiser_chk_path = "vulture/trained_models/dvt.pth"
# autoenc_chk_path = "vulture/trained_models/dac_dv2_denoised_e500.pth"
...
try:
    ...
    #     "LOFTUP_COMPRESSED", up_chk_path, denoiser_chk_path, autoenc_chk_path, "cuda:0", True, True, True
    # )
